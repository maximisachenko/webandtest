  ...
  return (
    ...
    >
      <div
        ...
        className={cn("relative mx-8", className)}
        role="region"
    ...
    <CarouselButton
      ...
      className={cn(
        ...
        orientation === "horizontal"
          ...
          : "-top-15 left-1/2 -translate-x-1/2 rotate-90",
        className
      )}
      ...
      {...props}
    >
      <Image src="/assets/icons/leftslider.svg" width={120} height={120} alt="Right button slider" />
    </CarouselButton>
  )
}
    ...
    <CarouselButton
      ...
      className={cn(
        ...
        orientation === "horizontal"
          ...
          : "-bottom-15 left-1/2 -translate-x-1/2 rotate-90",
        className
      )}
      ...
      {...props}
    >
      <Image src="/assets/icons/rightslider.svg" width={120} height={120} alt="Right button slider" />
    </CarouselButton>
  )
}
