...
Сегодня Weband активно развивает продукт HypeCash — финансовую платформу нового поколения, сочетающую интеллектуальный анализ, автоматизацию процессов и удобный пользовательский опыт. Мы стремимся создавать технологии, которые меняют рынок и открывают новые возможности для наших клиентов.

Наша команда состоит из 7 увлечённых специалистов:

— Сергей Савицкий — генеральный директор, стратег и основатель компании, бегает 100 км в день
— Никита Каребо — FullStack разработчик 
— Полина Глушеня — Fullstack разработчик
— Алексей Асташевич — стажёр 
— Катя Киселёвская — HR-менеджер, занимается подбором и развитием команды  
— Павел — менеджер проектов, отвечает за коммуникацию с клиентами и контроль задач  
- Максим Исаченко - стажёр

Мы строим компанию на ценностях доверия, качества и технологического лидерства. Наш подход — это постоянное развитие, гибкие методологии и ориентация на результат.
